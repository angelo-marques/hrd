...
(function ($) {
	...
	var loadFamax = function() {
		...
		$('#famax').append('<div id="famax-encloser">'+famaxColumnsHTML+'<div class="load-more-wrapper"><span class="load-more" id="load-more">VEJA MAIS</span></div></div>');
